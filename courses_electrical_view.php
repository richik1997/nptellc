...
$query="SELECT * FROM `electrical` WHERE `id` LIKE '$id'";
...
$course_institute=$row['institute'];
$course_professor=$row['professor'];
$course_link=$row['youtube'];
$course_videos=$row['videos'];
?>
<!doctype html>
<html class="no-js" lang="en">
    ...
    <body style="background: linear-gradient(to right,  #F0F8FF 0%,  #A9A9A9 100%);">
                ...
                <div class="row equalize sm-equalize-auto"> 
                    <div class="col-md-5 col-sm-12 col-xs-12 display-table sm-margin-50px-bottom">
                        <div class="display-table-cell vertical-align-middle">
                            <h5 class="alt-font text-extra-dark-gray font-weight-600"><?php echo $course_name; ?></h5>
                            <ul class="no-padding">
                                <li><?php echo $course_institute; ?></li>
                                <li><?php echo $course_professor; ?></li>
                                <li><?php echo $course_videos; ?> videos</li> 
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-7 col-sm-12 col-xs-12 display-table">
                        <div class="display-table-cell vertical-align-middle text-center xs-no-padding-right">
                            <iframe width="650" height="415" src="<?php echo $course_link; ?>" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <section class="bg-light-gray wow fadeIn" style="background: linear-gradient(to right,  #F0F8FF 0%,  #A9A9A9 100%);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 center-col margin-eight-bottom sm-margin-40px-bottom xs-margin-30px-bottom text-center">
                        <div class="alt-font text-extra-dark-gray margin-5px-bottom text-uppercase text-small"><h5><b>More Courses for You</b></h5></div>
                    </div>
                </div>
            ...
            while($row=mysqli_fetch_assoc($result))
                {
                    if($row['id']!=$id) {
                           echo ' <div class="col-md-4 col-sm-6 col-xs-12 swiper-slide sm-margin-four-bottom">
                                <div class="margin-half-all bg-white box-shadow-light text-center padding-fourteen-all xs-padding-30px-all" >
                                    <span class="text-extra-dark-gray text-small text-uppercase display-block line-height-10 alt-font font-weight-600"><b>'.$row['name'].'</b></span>
                                        <br>
                                    <p class="sm-margin-15px-bottom xs-margin-20px-bottom">'.$row['institute'].'<br>
                                 '.$row['professor'].'<br>'.$row['videos'].' videos</p>
                                 <a href="courses_electrical_view.php?id='.$row['id'].'" class="link" ><span>VIEW</span></a>
                                   <style>
