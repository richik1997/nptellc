...
<html class="no-js" lang="en">
    ...
    <body style="background: linear-gradient(to right,  #F0F8FF 0%,  #A9A9A9 100%);">
        <!-- start header -->
                ...
                <div class="container nav-header-container">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-xs-5">
                            <a href="index.html" title="NPTEL Local Chapter" class="logo"><img src="image/nptel_logo.png" data-at2x="images/logo@2x.png" class="logo-dark default" alt="Pofo"></a>
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row equalize sm-equalize-auto">
                    ...
                    <div class="row">
                    <iframe width="400" height="300" src="https://www.youtube.com/embed/atJO4HBZKDk" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div class="row">
                    <div>
                    <div class="col-md-3 col-sm-6"><img src="image/Image-01.jpg"></div>
                    <div class="col-md-3 col-sm-6"><img src="image/Image-02.jpg"></div>
                    <div class="col-md-3 col-sm-6"><img src="image/Image-03.jpg"></div>
                    <div class="col-md-3 col-sm-6"><img src="image/Image-04.jpg"></div>
                    </div>
                     </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 display-table last-paragraph-no-margin">
                        <div class="display-table-cell vertical-align-middle padding-twelve-left sm-text-center sm-no-padding-lr">
                            <h5 class="alt-font text-extra-dark-gray font-weight-600">NPTEL (National Programme on Technology Enhanced Learning) is a joint initiative of the IITs and IISc. Through this initiative, online courses and certification in various topics are offered.</h5>
                            <p class="text-extra-large width-90 font-weight-300 sm-width-100">Online course: Free for all, Certification exam: For a nominal fee. Learn anytime, anywhere! Only requirement: Interest and enthusiasm to learn 
 <br>
The start/end dates and exam dates are as follows:<br>
    <b>4 weeks course:</b> Start date: 5 Feb 2018 End date: 2 March 2018<br>
   <b> 8 weeks course:</b> Start date: 5 Feb 2018 End date: 30 March 2018<br>
    <b>12 weeks course:</b> Start date: 22 Jan 2018 End date: 13 April 2018<br>
Last date of Enrollment for 12 week courses are extended till Jan 29, 2018
<br>
<b>Exam Date</b>
<br> 
Exam dates for all courses: <b>28/29 April (2 sessions per day: FN-9 AM to 12 noon AN-2 PM to 5 PM)</b></h6></p>
                            <a href="https://onlinecourses.nptel.ac.in/" class="btn btn-small btn-rounded btn-dark-gray margin-30px-top">Online Courses</a>
                        </div>
                    </div>
                </div>
            </div>
